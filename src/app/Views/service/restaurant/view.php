...
<head>
    ...
    <style>
        ...
        .rv-price-badge { background: #fff3e0; color: #e67e22; font-size: 12px; padding: 3px 10px; border-radius: 20px; font-weight: 500; }
        ...
        .rv-info-key { color: #4a90e2; font-weight: 600; min-width: 80px; }
...
<!-- 상단 내비바 — 패널과 동일한 너비/위치로 CSS 오버라이드됨 -->
